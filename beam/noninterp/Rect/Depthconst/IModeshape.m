function [Breadth,Lambda]=IModeshape(E,Rho,U,Depth,L,numele,fixeddofs,Vol,tol,flag)
...
CoMul=Depth*Le;
if(flag==1)
    [Breadth,Lambda]=PowerIter(psK,psM,K(freedofs,:),M(freedofs,:),1,CoMul,Vol,tol);
else
    [Breadth,Lambda]=EigAna(psK,psM,K(freedofs,:),M(freedofs,:),CoMul,Vol,tol);
end
